package MalleDB.src.main.java.db;

import MalleDB.src.main.java.connectors.Cassandra;
import MalleDB.src.main.java.connectors.LevelDB;
import MalleDB.src.main.java.connectors.MySQL;
import MalleDB.src.main.java.connectors.Redis;
import MalleDB.src.main.java.interfaces.SubDB;
import util.*;
import MalleDB.src.main.java.util.HashMap;

import java.io.*;
import java.nio.charset.StandardCharsets;
import java.util.*;

public class MalleDB implements MalleDB.src.main.java.interfaces.MalleDB {
